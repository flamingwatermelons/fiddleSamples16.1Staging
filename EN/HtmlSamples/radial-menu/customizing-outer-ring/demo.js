                ...
                [
                    {
                        name: "button1",
                        header: "Bold",
                        iconUri: "http://staging.igniteui.local/16-1/images/samples/radial-menu/Bold.png",
                        click: function () { toggleBold(); }
                    },
                    {
                        name: "button2",
                        header: "Italic",
                        iconUri: "http://staging.igniteui.local/16-1/images/samples/radial-menu/Italic.png",
                        click: function () { toggleItalic(); }
                    },
                    {
                        type: "numericitem",
                        header: "Font Size",
                        iconUri: "http://staging.igniteui.local/16-1/images/samples/radial-menu/Size.png",
                        value: "8",
                        items:
                        [
                            {
