            ...
            $("#grid12").igGrid({
                ...
                columns: [
                        ...
                        { headerText: "Phone", key: "Phone", dataType: "string" },
                        {
                            ...
                            template: "<img width='26' height='15' src='http://staging.igniteui.local/16-1/images/samples/nw/countries/{{>Country}}.gif'></img> <span style='display: table-cell;vertical-align: middle;'>{{>Country}}</span>"
                        },
                        {
