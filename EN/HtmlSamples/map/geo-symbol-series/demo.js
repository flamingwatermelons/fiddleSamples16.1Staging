$(function () {
            ...
            var shapeDataSource = new $.ig.ShapeDataSource({
                shapefileSource: "http://staging.igniteui.local/16-1/data-files/shapes/world_cities.shp",
                databaseSource: "http://staging.igniteui.local/16-1/data-files/shapes/world_cities.dbf",
