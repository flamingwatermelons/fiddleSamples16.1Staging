...
function ColorPickerByIndex(min, max) {
         ...
         $(function () {
            ...
            $("#map").igMap({
                ...
                overviewPlusDetailPaneBackgroundImageUri: "http://staging.igniteui.local/16-1/images/samples/maps/world.png",
                series: [{
                    type: "geographicShape",
                    name: "worldCountries",
                    markerType: "none",
                    shapeMemberPath: "points",
                    shapeDataSource: 'http://staging.igniteui.local/16-1/data-files/shapes/world_countries_reg.shp',
                    databaseSource: 'http://staging.igniteui.local/16-1/data-files/shapes/world_countries_reg.dbf',
                    opacity: 0.8,
                    outlineThickness: 1,
                    showTooltip: true,
