...
var alternate = true;
        $(function () {
            $("#player1").igVideoPlayer({
                ...
                width: "100%",
                posterUrl: 'http://staging.igniteui.local/16-1/images/samples/video-player/ig-pres.png',
                fullscreen: false,
                ...
                banners: [{
                    imageUrl: 'http://staging.igniteui.local/16-1/images/samples/video-player/banner.png',
