$(function () {
            $("#player1").igVideoPlayer({
                ...
                width: 720,
                height: 560,
                posterUrl: "http://jp.staging.igniteui.local/16-1/images/samples/video-player/quince-intro-1.png",
                fullscreen: false,
                ...
                relatedVideos: [{
                    imageUrl: "http://jp.staging.igniteui.local/16-1/images/samples/video-player/quince-intro-2.png",
                    title: "Quince プレゼンテーション パート 1",
