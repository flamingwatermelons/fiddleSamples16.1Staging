            ...
            $("#grid12").igGrid({
                ...
                columns: [
                        ...
                        { headerText: "電話", key: "Phone", dataType: "string" },
                        {
                            ...
                            template: "<img width='26' height='15' src='http://jp.staging.igniteui.local/16-1/images/samples/nw/countries/{{>Country}}.gif'></img> <span style='display: table-cell;vertical-align: middle;'>{{>Country}}</span>"
                        },
                        {
