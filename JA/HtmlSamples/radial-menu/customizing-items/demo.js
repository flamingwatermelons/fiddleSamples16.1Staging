                ...
                [
                    {
                        name: "button1",
                        header: "太字",
                        iconUri: "http://jp.staging.igniteui.local/16-1/images/samples/radial-menu/Bold.png",
                        click: function () { toggleBold(); }
                    },
                    {
                        name: "button2",
                        header: "イタリック",
                        iconUri: "http://jp.staging.igniteui.local/16-1/images/samples/radial-menu/Italic.png",
                        click: function () { toggleItalic(); }
                    },
                    {
                        type: "numericitem",
                        header: "フォント サイズ",
                        iconUri: "http://jp.staging.igniteui.local/16-1/images/samples/radial-menu/Size.png",
                        value: "8",
                        items:
                        [
                            {
